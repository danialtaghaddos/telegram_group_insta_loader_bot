...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if admin:
        ...
        text += "/hold - Reply to a user's message in a group to put them on hold (their links are ignored)\n"
        text += "/unhold - Reply to a user's message, or /unhold user_id/@username, to remove them from hold\n"
        text += "/holdList - List all users currently on hold\n\n"
    elif is_mod:
